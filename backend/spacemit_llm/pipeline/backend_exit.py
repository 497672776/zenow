...
class BackendExitHandler:
    ...
    def _cleanup(self):
        ...
        try:
            # During exit, use synchronous cleanup to avoid async issues
            self.server_manager.stop_all_sync()
    ...
    def _sync_cleanup(self):
        """Synchronous cleanup for when async is not available"""
        # This method is now replaced by server_manager.stop_all_sync()
        self.server_manager.stop_all_sync()
