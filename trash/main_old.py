...
from src.pipeline.chat import ChatPipeline
...
chat_pipeline = ChatPipeline(server_manager, db_config, db_session)
...
@app.get("/api/models/server_status")
...
async def chat(request: ChatRequest):
    ...
    """
    return await chat_pipeline.process_chat(request)
